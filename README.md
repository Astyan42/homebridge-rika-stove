...
Plugin for controlling RIKA Corso enabled stoves via [Homebridge](https://github.com/nfarina/homebridge). It currently only supports the stove's "Comfort mode". In this mode, you control the stove as if it were a thermostat.
